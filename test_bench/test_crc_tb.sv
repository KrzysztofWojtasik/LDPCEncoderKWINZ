...
// ============================================================================
// test_crc_tb
// Testbench weryfikujący moduł crc_tb_parallel (CRC dopisywane do TB w strumieniu
// równoległym 64-bit).
//
...
//  - Koniec testu: out_last (koniec TB) lub timeout.
// ============================================================================

module test_crc_tb;

  // === KONFIG ===
  localparam string VEC_DIR_MAT    = "../vectors/TB_crc/Output_Matlab";
  localparam string VEC_DIR_RESULT = "../vectors/TB_crc/Output_DUT_parallel";
  ...
  logic [15:0]         in_tb_len, out_tb_len;
  ...
  crc_tb_parallel dut (
    ...
    .out_valid, .out_chunk, .out_last,.out_tb_len
  );
